...
const Support = () => {
  ...
  return (
    <div className="pt-20">
      {/* Hero Section */}
      <Section className="bg-gradient-to-b from-gray-900 to-gray-950 flex items-center">
          ...
          >
            <div className="bg-gray-900 rounded-lg p-8">
              ...
              <p className="text-gray-300 mb-6">
                Our team of IT experts is ready to help you with any technical challenges, system integration, or infrastructure needs.              </p>
